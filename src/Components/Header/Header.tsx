...
const Header = () => {
    ...
    return (
        <nav className="bg-bg1 border-gray-200 px-2 sm:px-4 py-3.5">
            <div className="container flex flex-wrap justify-between items-center mx-auto">
                ...
                <div className="hidden w-full md:block md:w-auto" id="mobileMenu">
                    <ul className="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-base md:font-medium text-gray-400 ">
                        ...
                        <li>
                            <NavLink to={"/about"} className="block py-2 pr-4 pl-3 hover:text-white md:hover:bg-transparent border-gray-700">About</NavLink>
                        </li>
                    </ul>
                </div>
            </div>
